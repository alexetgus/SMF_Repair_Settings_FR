...
$txt['no_default_value'] = 'Valeur non recommand&eacute;e.';
$txt['save_settings'] = 'Sauvegarder les param&eacute;tres';
$txt['remove_file'] = 'Supprimer ce fichier. Attention, peut ne pas fonctionner sur certains serveurs';
$txt['restore_all_settings'] = 'Restaurer tous les param&eacute;tres';
$txt['not_writable'] = 'Le fichier Settings.php ne peut pas &ecirc;tre &eacute;crit. Modifiez les droits d\'acc&egrave;s &agrave; ce fichier.';
$txt['recommend_blank'] = '<em>(blank)</em>';
$txt['database_settings_hidden'] = 'Certains param&egrave;tres ne sont pas affich&eacute;s car les informations de connexion &agrave; la base de donn&eacute;es sont incorrectes.<br />V&eacute;rifiez les d&eacute;tails de connexion de votre base de donn&eacute;es, le pr&eacute;fixe des tables et que la base de donn&eacute;es contient bien vos tables SMF.';
$txt['no_sources'] = 'Le dossier Sources n\'a pas &eacute;t&eacute; trouv&eacute;. Ce dossier est essentiel pour que cet outil fonctionne. Assurez-vous qu\'il existe.';
$txt['settings_saved'] = 'Vos param&egrave;tres ont &eacute;t&eacute; sauvegard&eacute;s. Confirmez tous les chemins et les URLs ci-dessous, et v&eacute;rifiez que votre forum fonctionne.<br /> <b> Assurez-vous de supprimer ce fichier !</b>';

$txt['remove_hooks'] = 'Retirer tous les hooks';
$txt['disable_hooks'] = 'D&eacute;sactiver tous les hooks';
$txt['hooks_removed'] = 'Tous les hooks existants ont &eacute;t&eacute; retir&eacute;s de la base de donn&eacute;es. Notez que les MODs existants qui d&eacute;pendent des hooks ne fonctionneront plus.<br /><b>Assurez-vous de supprimer ce fichier !</b>';
...
$txt['maintenance2'] = 'Inutilisable <em>(non recommand&eacute; !)</em>';
$txt['language'] = 'Fichier de langue ';
$txt['cookiename'] = 'Nom du Cookie ';
$txt['queryless_urls'] = 'URLs simplifi&eacute;es';
$txt['queryless_urls0'] = 'Off (recommand&eacute;)';
$txt['queryless_urls1'] = 'On';
$txt['enableCompressedOutput'] = 'Compression des pages ';
$txt['enableCompressedOutput0'] = 'Off (recommand&eacute; si vous avez des probl&egrave;mes)';
$txt['enableCompressedOutput1'] = 'On (pr&eacute;serve votre bande passante)';
$txt['databaseSession_enable'] = 'Sessions en base de donn&eacute;es ';
$txt['databaseSession_enable0'] = 'Off (non recommand&eacute;)';
$txt['databaseSession_enable1'] = 'On (recommand&eacute;)';
$txt['theme_default'] = 'D&eacute;finir le th&egrave;me par d&eacute;faut de SMF en tant que th&egrave;me<br />pour tous les utilisateurs ';
$txt['theme_default0'] = 'Non (conserver les param&eacute;tres actuels des utilisateurs)';
$txt['theme_default1'] = 'Oui (recommand&eacute; si vous avez des probl&egrave;mes)';

$txt['database_settings'] = 'Informations de la base de donn&eacute;es';
$txt['database_settings_info'] = 'Il s\'agit du serveur, du nom d\'utilisateur, du mot de passe et de la base de donn&eacute;es de votre serveur.';
$txt['db_type'] = 'Moteur de base de donn&eacute;es ';
$txt['db_server'] = 'Serveur ';
$txt['db_name'] = 'Nom de la base ';
$txt['db_user'] = 'Non d\'utilisateur ';
$txt['db_passwd'] = 'Mot de passe ';
$txt['ssi_db_user'] = 'Non d\'utilisateur SSI ';
$txt['ssi_db_passwd'] = 'Mot de passe SSI ';
$txt['ssi_db_user_desc'] = '(Optionnel)';
$txt['ssi_db_passwd_desc'] = '(Optionnel)';
$txt['db_prefix'] = 'Pr&eacute;fixe des tables ';
$txt['db_persist'] = 'Type de connexion ';
$txt['db_persist0'] = 'Standard (recommand&eacute;)';
$txt['db_persist1'] = 'Persistante (peut causer des probl&egrave;mes)';
$txt['db_mysql'] = 'MySQL';
$txt['db_postgresql'] = 'PostgreSQL';
$txt['db_sqlite'] = 'SQLite';

$txt['cache_settings'] = 'Param&egrave;tres du cache';
$txt['cache_settings_info'] = 'Il s\'agit des param&egrave;tres du cache de votre installation de SMF. Ils peuvent causer de gros probl&egrave;mes quand ils sont &eacute;rron&eacute;s.';
$txt['cache_accelerator'] = 'Cache Syst&egrave;me ';
$txt['cache_accelerator_help'] = 'Choississez: apc, eaccelerator, memcache, mmcache, output_cache, smf, ou xcache';
$txt['cache_enable'] = 'Activer le cache ';
$txt['cache_enable0'] = 'Off';
$txt['cache_enable1'] = 'On (recommand&eacute;)';
$txt['cachedir'] = 'R&eacute;pertoire du cache ';
$txt['cache_memcached'] = 'Serveurs Memcache ';

$txt['path_url_settings'] = 'Chemins &amp; URLs';
$txt['path_url_settings_info'] = 'Il s\'agit des chemins et URLs de votre installation de SMF. Ils peuvent causer de gros probl&egrave;mes quand ils sont &eacute;rron&eacute;s.  D&eacute;sol&eacute;, il y en a beaucoup.';
$txt['boardurl'] = 'URL du forum ';
$txt['boarddir'] = 'R&eacute;pertoire du Forum ';
$txt['sourcedir'] = 'R&eacute;pertoire "Sources" ';
$txt['tasksdir'] = 'R&eacute;pertoire "Tasks" ';
$txt['packagesdir'] = 'R&eacute;pertoire "Packages" ';
$txt['attachmentUploadDir'] = 'R&eacute;pertoire "Attachment" ';
$txt['avatar_url'] = 'URL des avatars ';
$txt['avatar_directory'] = 'R&eacute;pertoire des avatars ';
$txt['custom_avatar_url'] = 'URL des avatars personnalis&eacute;s ';
$txt['custom_avatar_dir'] = 'R&eacute;pertoire des avatars personnalis&eacute;s ';
$txt['smileys_url'] = 'URL des smileys ';
$txt['smileys_dir'] = 'R&eacute;pertoire des smileys ';
$txt['theme_url'] = 'URL du th&egrave;me par d&eacute;faut ';
$txt['images_url'] = 'URL des imgages du th&egrave;me par d&eacute;faut ';
$txt['theme_dir'] = 'R&eacute;pertoire du th&egrave;me par d&eacute;faut ';

$txt['theme_path_url_settings'] = 'Chemins &amp; URLs des th&egrave;mes';
$txt['theme_path_url_settings_info'] = 'Il s\'agit des chemins et th&egrave;mes de votre installation de SMF.';
